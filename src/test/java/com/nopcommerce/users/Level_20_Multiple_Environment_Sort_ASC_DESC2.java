...
@Feature("User")
public class Level_20_Multiple_Environment_Sort_ASC_DESC2 extends AbstractTest{
	...
	public void beforeClass(String browsername) {
		...
		System.out.println("Host name :" +env.databaseHostname());
		System.out.println("User Name :" +env.databaseUserName());
		System.out.println("Pass word :" +env.databasePassWord());
