...
public class AbstractPage {
	...
	public void selectItemInCustomDropdown(WebDriver driver, String parentLocator, String childItemLocator, String expectedItem) {
	  ...
	  public void sendKeysBoardToElement(WebDriver driver,String lorcator, Keys key) {
		...
		public UserHomePO clickToHomeButton(WebDriver driver) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.HOME_BUTTON);
			clickToElement(driver, NopcommerceAbstractPageUI.HOME_BUTTON);
			return PageGeneratorManager.geUsertHomePage(driver);
		}
		public UserSearchPO clickToSearchLink(WebDriver driver) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.SEARCH_LINK);
			clickToElement(driver, NopcommerceAbstractPageUI.SEARCH_LINK);
			return PageGeneratorManager.getUserSearchPage(driver);
		}

		public UserWishlistPO clickToWishlistLink(WebDriver driver) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.WISHLIST_LINK);
			clickToElement(driver, NopcommerceAbstractPageUI.WISHLIST_LINK);
			return PageGeneratorManager.getUserWishlistPage(driver);
		}
		public UserShippingPO clickToShippingLink(WebDriver driver) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.SHIPPING_LINK);
			clickToElement(driver, NopcommerceAbstractPageUI.SHIPPING_LINK);
			return PageGeneratorManager.getUserShippingPage(driver);
		}public UserSitePO clickToSiteLink(WebDriver driver) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.SITE_LINK);
			clickToElement(driver, NopcommerceAbstractPageUI.SITE_LINK);
			return PageGeneratorManager.getUserStiePage(driver);
		}
		public UserFooterMyAccountPO clickToFooterLink(WebDriver driver) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.FOOTER_MY_ACCOUNT_LINK);
			clickToElement(driver, NopcommerceAbstractPageUI.FOOTER_MY_ACCOUNT_LINK);
			return PageGeneratorManager.getUserFooterPage(driver);
		}
		// Shound 10-15 page
		...
		public void clickToRadionButtonByID(WebDriver driver, String radidoButtonID) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_RADIDO_BUTTON_BY_ID, radidoButtonID);
			clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_RADIDO_BUTTON_BY_ID, radidoButtonID);
		}
		...
		public void selectDropDownByName(WebDriver driver, String selectName, String itemValue) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_SELECT_BY_NAME, selectName);
			selectItemInDropdown(driver, NopcommerceAbstractPageUI.DYNAMIC_SELECT_BY_NAME, itemValue, selectName);
		}
		public void clickToButtonByValue(WebDriver driver, String butonValue) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_BUTTON_BY_VALUE, butonValue);
			clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_BUTTON_BY_VALUE, butonValue);
		}
		public String getErrorMessageAtMandatoryFieldByName(WebDriver driver, String valueName) {
			waitToElementVisible(driver, NopcommerceAbstractPageUI.DYNAMIC_ERROR_MESSAGE_BY_ID, valueName);
			return getElementText(driver, NopcommerceAbstractPageUI.DYNAMIC_ERROR_MESSAGE_BY_ID, valueName);
		}
		
		public void waitToAjaxLoadingPage(WebDriver driver) {
...
//			sleepInSecond(3);
		...
		public void clickToPlusIconByPanelID(WebDriver driver,String ID) {
			waitToElementClickable(driver, NopcommerceAbstractPageUI.PLUS_ICON_PANEL, ID);
			String iconAttributeValue = getElementAttibute(driver, NopcommerceAbstractPageUI.PLUS_ICON_PANEL,"class", ID);
			if (iconAttributeValue.contains("fa-plus")) {
				clickToElement(driver, NopcommerceAbstractPageUI.PLUS_ICON_PANEL,ID);
				sleepInSecond(1);
			}
		}
