...
public class AdminProductsPageUI {
	public static final String PRODUCT_LINK_TEXT = "//span[text()='Products']";
	...
	public static final String COLLUM_NAME_INDEX = "//th[text()='%s']/preceding-sibling::th";
	public static final String CELL_VALUE_MIX_COLUMN_AND_ROW_INDEX = "//tr[%s]/td[%s]";
	public static final String CHECK_STATUS_COLUMN_AND_ROW_INDEX = "//tr[%s]/td[%s]/i[contains(@class,'%s-icon')]";
	public static final String EDIT_ICON_BY_NAME = "//td[text()='%s']/following-sibling::td/a/i";
	
	public static final String SEARCH_PRODUCT_NAME_INPUT_TEXTBOX = "//input[@id='SearchProductName']";
	...
	public static final String  DISPLAY_UP_AND_DOWN_ORDER_BUTTON = "//input[@id='AddPictureModel_DisplayOrder']/following-sibling::span/span[@title='%s value']";
	...
	public static final String  DELETE_ALL_IMAGE_IN_PICTURE = "//td[@data-columnname='PictureUrl']/following-sibling::td//i[contains(@class,'fa-remove')]";
	public static final String  PRODUCT_DETAIL_IN_SEARCH = "//td/img[contains(@src,'%s')]/parent::td/following-sibling::td[text()='%s']/following-sibling::td[text()='%s']/following-sibling::td[text()='%s']/following-sibling::td[text()='%s']/following-sibling::td[text()='%s']/following-sibling::td/i[contains(@class,'%s-icon')]";
}
